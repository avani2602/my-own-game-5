...
function setup() {
  ...
  spike1 = createSprite(910,825,200,20);
  spike2 = createSprite(705,825,200,20);
  spike3 = createSprite(1510,580, 100,20);
  spike4 = createSprite(970,417,100,20);
  spike5 = createSprite(850,417,100,20);
  spike6 = createSprite(1050,180,200,20);
  spike7 = createSprite(1200,550,50,50);
  spike8 = createSprite(510, 460, 60, 60);
